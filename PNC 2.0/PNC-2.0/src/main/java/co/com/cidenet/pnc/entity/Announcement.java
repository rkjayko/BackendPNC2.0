...
public class Announcement {
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((InitialAnnouncementDate == null) ? 0 : InitialAnnouncementDate.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (EndAnnouncementDate == null) {
      if (other.EndAnnouncementDate != null) return false;
    } else if (!EndAnnouncementDate.equals(other.EndAnnouncementDate)) return false;
    if (InitialAnnouncementDate == null) {
      if (other.InitialAnnouncementDate != null) return false;
    } else if (!InitialAnnouncementDate.equals(other.InitialAnnouncementDate)) return false;
    if (announcementName == null) {
      if (other.announcementName != null) return false;
    } else if (!announcementName.equals(other.announcementName)) return false;
    if (id == null) {
