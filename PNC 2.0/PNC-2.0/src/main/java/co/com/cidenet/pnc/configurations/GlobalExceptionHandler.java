...
public class GlobalExceptionHandler {
  ...
  protected ResponseEntity<Object> handleNullPointerException(
      NullPointerException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
    return handleExceptionInternal(ex, headers, status, request);
  }
  ...
  private ResponseEntity<Object> handleControlledException(
      Exception controlledException, HttpHeaders headers, HttpStatus status, WebRequest request) {
